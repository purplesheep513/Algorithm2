...
// 위 그림은 6×4 격자에서 처음에 (4,1)에서 출발한 개미가 움직인 길을 보여주고 있다. 처음에 (4,1)에 있는 개미는 2시간 후에 (6,3)에 있으며 8시간 후에 (0,1)에 있다. 
...
public class TimeComplexity {
  public static void main(String[] args) {
    ...
    System.out.print(lapX % 2 == 0 ? w - Math.abs(diffX) : diffX);
    System.out.print(' ');
    System.out.print(lapY % 2 == 0 ? h - Math.abs(diffY) : diffY);
    sc.close();
  }
}
